...
type LedgerEntry = AccountRoot | Amendments | AMM | Bridge | Check | Credential | Delegate | DepositPreauth | DirectoryNode | Escrow | FeeSettings | LedgerHashes | Loan | LoanBroker | NegativeUNL | Offer | Oracle | PayChannel | PermissionedDomain | RippleState | SignerList | Ticket | Vault | XChainOwnedClaimID | XChainOwnedCreateAccountClaimID;
